...
test("Najprostszy test formularza logowania", async ({ page, context }) => {
  ...
  console.log(
    "Test prosty: Liczba elementów formularza:",
    "Email:",
    emailInputCount,
    "Hasło:",
    passwordInputCount,
  ...
  if (formCount === 0 || emailInputCount === 0) {
    ...
    console.log(
      "Test prosty: Liczba elementów formularza z nagłówkami:",
      "Email:",
      emailInputCountWithHeaders,
      "Hasło:",
      passwordInputCountWithHeaders,
      "Przycisk:",
      submitButtonCountWithHeaders
    );
