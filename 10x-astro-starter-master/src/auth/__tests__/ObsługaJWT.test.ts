...
describe('ObsługaJWT', () => {
  ...
  describe('weryfikacja tokenu', () => {
    it('powinien zweryfikować ważny token', () => {
      // Arrange
      const ważnyToken = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkphbiBLb3dhbHNraSIsImV4cCI6MTk1ODMyNDgwMH0.FPFEt9S16MZgIh0LrQmGsQj9uWa6GwRxlOw4iZ6ulAo';
    ...
    it('powinien odrzucić wygasły token', () => {
      // Arrange
      const wygasłyToken = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkphbiBLb3dhbHNraSIsImV4cCI6MTUxNjIzOTAyMn0.FPFEt9S16MZgIh0LrQmGsQj9uWa6GwRxlOw4iZ6ulAo';
