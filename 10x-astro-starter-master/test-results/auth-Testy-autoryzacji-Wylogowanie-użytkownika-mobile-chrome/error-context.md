...
- Name: Testy autoryzacji >> Wylogowanie użytkownika
- Location: /home/mariusz/Projekty/10x-cards/10x-astro-starter-master/tests/e2e/auth.spec.ts:133:3
...
Call log:
  - waiting for getByTestId('auth-email-input')
    ...
    at /home/mariusz/Projekty/10x-cards/10x-astro-starter-master/tests/e2e/auth.spec.ts:136:46
```
