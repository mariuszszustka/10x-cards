    ...
    >
      ...
      <div className="p-4 h-full flex flex-col">
        ...
        <div className="flex justify-between items-start mb-2 z-20">
          <span className={`text-xs px-2 py-1 rounded-full ${sourceInfo.cssClass}`}>{sourceInfo.label}</span>
        ...
        >
          <div className="max-w-full">
            <p className="text-lg leading-relaxed text-foreground">{isFlipped ? flashcard.back : flashcard.front}</p>
          </div>
        </div>
        ...
        <div className="mt-4 flex justify-end gap-2 z-20">
          ...
          <Button size="sm" variant="destructive" onClick={handleDelete} data-testid="delete-flashcard-button">
            Usuń
          </Button>
        </div>
      </div>
