...
export const AVAILABLE_OLLAMA_MODELS = ["gemma3:27b", "llama3.2:3b", "deepseek-r1:32b", "llama3.3:latest"];
 ...
 */
export async function generateFlashcards(sourceText: string, model: string): Promise<GeneratedFlashcard[]> {
...
export function extractKeyTerms(text: string): string[] {
  ...
  const terms = ["Przykładowe pojęcie 1", "Przykładowe pojęcie 2", "Przykładowe pojęcie 3"];
